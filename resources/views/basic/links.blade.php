                ...
                <div class="c-content-client-logos-1">
                    ...
                    <div class="c-logos">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-xs-12 c-logo c-logo-2">
                                <a href="#">
                                    <img class="c-img-pos mimi-logo-links" src="{!! asset('images/logo_min.png') !!}" alt="">
                                </a>
                            </div>
                            <div class="col-md-12 col-xs-12 c-logo c-logo-3">
                                <a href="#">
                                    <img class="c-img-pos mimi-logo-links" src="{!! asset('images/logo_ISPRA2.png') !!}" alt="">
                                </a>
                            </div>
                            <div class="col-md-12 col-xs-12 c-logo c-logo-4">
                                <a href="#">
                                    <img class="c-img-pos mimi-logo-links" src="{!! asset('images/logoNaturaitalia.png') !!}" alt="">
                                </a>
                            </div>
                            <div class="col-md-12 col-xs-12 c-logo c-logo-5">
                                <a href="#">
