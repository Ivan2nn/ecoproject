        ...
        <div class="ibox-content col-sm-12">
          <div class="row">
            <div class="col-sm-12 col-md-4">
              <form method="GET" action="taxonomytospecies" v-ajax>
                    {!! csrf_field() !!}
                <div class="row">
            ...
            <div class="col-sm-12 col-md-4">
              ...
              <form method="GET" action="biogeographicregtospecies" v-ajax>
                  {!! csrf_field() !!}
                <div class="row">
                  <div class="col-sm-12">
                    <h2>ALP</h2>
            ...
            <div class="col-sm-12 col-md-4">
              <form method="GET" action="conservationstatetospecies" v-ajax>
                  {!! csrf_field() !!}
                  <div class="row">
                  <div class="col-sm-12">
                    <h2>FV</h2>
